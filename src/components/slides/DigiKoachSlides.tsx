    ...
    content: (
      <div className="wrap">
        <div data-anim>
          ...
          <h2 className="h-title">Training that starts<br />at the actual gap.</h2>
        ...
        <div className="orb-stage">
          <img className="dv-brain-bg" src={`${A}Gemini_Generated_Image_9c48rn9c48rn9c48__1_-removebg-preview.png`} alt="" aria-hidden="true" />
    ...
    content: (
      <div className="wrap">
        <div data-anim>
          ...
          <h2 className="h-title">Generic training was fixing<br />problems agents didn't have.</h2>
    ...
    content: (
      <div className="wrap">
        <div data-anim>
          ...
          <h2 className="h-title">Growth tracked the same<br />way gaps were found.</h2>
          <div className="stat-row" style={mt(20)}>
